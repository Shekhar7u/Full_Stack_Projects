        ...
        <div className='home'>
            <div className="home_container">
                <img
                    ...
                    src="https://images-eu.ssl-images-amazon.com/images/G/31/img23/Fashion/GW/July/Apay/Deals-Unrec-PC-1500_2._CB598748121_.jpg" alt="banner" />

                <div className="home_row">
                    <Product title='Lean Startup: The Million Copy Bestseller Driving Entrepreneurs to Success'
                        price={29.99}
                        image="https://m.media-amazon.com/images/I/51T-sMqSMiL._SY264_BO1,204,203,200_QL40_FMwebp_.jpg"
                        rating={3} />
                    
                    <Product title='Rossmann Professional 1600 Watts Stand Mixer, 100% Pure Copper Motor, 4 Safety Features, Metal Gears & Planetary Rotation, 6 Lit SS Bowl, Teflon Coated Accessories, 2 Years Warranty, Black'
                        price={229.99}
